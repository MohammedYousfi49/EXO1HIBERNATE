...
public class TestLigneCommaandeProduit {
    public static void main(String[] args) {
        ...
        LigneCommandeProduitService lcps = new LigneCommandeProduitService();
         ...
         lcps.create(new LigneCommandeProduit(new LigneCommandeProduitPk(p1.getId(), c.getId()),20));
         lcps.create(new LigneCommandeProduit(new LigneCommandeProduitPk(p2.getId(), c.getId()), 10));
